...
export const CellAction: React.FC<CellActionProps> = ({
  ...
  const onConfirm = async () => {
    try {
      setLoading(true);
      await fetchWrapper.delete(`/api/corprodutos/${data.id}`);
  ...
  const onCopy = (id: string) => {
    ...
    toast.success('ID da Cor de Produto copiado para área de transferência.');
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => router.push(`/corprodutos/${data.id}`)}
          >
